...
import { EnsureIsFolderUri, ReadUri, ResolveUri, ToRawDataUrl, WriteString } from "@microsoft.azure/async-io";
...
import { Lazy, OperationCanceledException } from "@microsoft.azure/polyfill";
